...
// Speed add (alphablend disable & test)
#define	BLEND_ALPHABLEND_DISABLE	8
#define	BLEND_ALPHABLEND_ENABLE		0
#define	BLEND_ALPHATEST_DISABLE		16
#define	BLEND_ALPHATEST_ENABLE		0
...
enum hgeBoolState
{
	...
	HGE_TEXTURECLAMP	= 4,	// bool     clamp textures?     (default: false)

//	HGE_USESOUND		= 5,    // bool		use BASS for sound?	(default: true)

	HGE_DONTSUSPEND		= 6,	// bool		focus lost:suspend?	(default: false)
	HGE_HIDEMOUSE		= 7,	// bool		hide system cursor?	(default: true)

	HGE_SHOWSPLASH		= 8,	// bool		hide system cursor?	(default: true)
...
enum hgeFuncState
{
	HGE_FRAMEFUNC		= 9,    // bool*()	frame function		(default: NULL) (you MUST set this)
	HGE_RENDERFUNC		= 10,   // bool*()	render function		(default: NULL)
	HGE_FOCUSLOSTFUNC	= 11,   // bool*()	focus lost function	(default: NULL)
	HGE_FOCUSGAINFUNC	= 12,   // bool*()	focus gain function	(default: NULL)
	HGE_GFXRESTOREFUNC	= 13,   // bool*()	exit function		(default: NULL)
	HGE_EXITFUNC		= 14,   // bool*()	exit function		(default: NULL)
...
// 	HGE_STREAMVOLUME	= 23,   // int		global music volume	(default: 100)
	...
	HGE_SCREENADAPTERID = 26,	// int		DirectX Adapter (0 for primary screen, 1 for secondary ...)
...
enum hgeStringState
{
	HGE_ICON			= 27,   // char*	icon resource		(default: NULL)
	HGE_TITLE			= 28,   // char*	window title		(default: "HGE")
	
	HGE_INIFILE			= 29,   // char*	ini file			(default: NULL) (meaning no file)
	HGE_LOGFILE			= 30,   // char*	log file			(default: NULL) (meaning no file)
...
// 	virtual bool		CALL	Channel_IsSliding(HCHANNEL channel) = 0;
	...
	virtual void		CALL	Gfx_RenderCircle(float x, float y, float radius, DWORD color=0xFFFFFFFF, float z=0.5f) = 0;
	...
	virtual void		CALL	Gfx_SetDisplayMode(int width, int height, int bpp) =0;
